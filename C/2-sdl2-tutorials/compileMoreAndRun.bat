...
::@rem C4819字符警告在设了/execution-charset:utf-8,且汉字数量为奇数，只好通过/wo4819只显示一次该告警
::禁用5045告警，已配置/Qspectre防止cpu预测执行 

set _CL_OPT=%DEFINE_OPT% /Wall /wo4819  /wd5045 /Qspectre /source-charset:utf-8 /execution-charset:%srcCharset% /Fo"%tgtDir%\\" /Fe"%tgexe%" /I include @"%srcCFile%" /std:c11 /nologo /link /SUBSYSTEM:CONSOLE
