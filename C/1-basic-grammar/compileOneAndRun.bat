...
set _CL_OPT=/Gy %DEFINE_OPT% /Wall /wo4819 /wd5045 /Qspectre /source-charset:utf-8 /execution-charset:%srcCharset%  "%srcFile%" /I include /Fo"%tgexe%" /Fe"%tgexe%" /std:c11 /nologo /link %LIB_DEPENDS% /SUBSYSTEM:CONSOLE
