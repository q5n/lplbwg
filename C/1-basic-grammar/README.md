...
> 
> /*3.将pInt16强转为pInt8_2, 指向地址值不变，
>  *  指向类型变为int8_t, 意味着指针解引用后的数据类型为int8_t，指针加法运算单位变为1字节 
>  */
> int8_t* pInt8_2=(int8_t*)pInt16;
> 
> /*4.将pInt8强转为pInt16_2, 指向地址值不变，
>  *  指向类型变为int16_t, 意味着指针解引用后的数据类型为int16_t，指针加法运算单位变为2字节 
>  */
> int16_t* pInt16_2=(int16_t*)pInt8;
> ```
>
...
> 
>
> 定义接口： [my_list.h](include\my_list.h) 
>
>  
>
> 实现接口: [16_3_my_list_impl.c](src\16_3_my_list_impl.c) 
>
>  
>
> 使用接口： [16_4_my_list_films.c](src\16_4_my_list_films.c) 
>
> 
...
>  2.定义接口
>
>  [my_queue.h](include\my_queue.h) 
>
> 3.实现接口
>
>  [16_5_my_queue_impl.c](src\16_5_my_queue_impl.c) 
>
> 4.接口使用: 
>
> [16_6_use_my_queue.c](src\16_6_use_my_queue.c) 
...
> 类型操作： 初始化树为空、确定树是否为空、确定树是否已满、确定树中的项数、在树中添加一个项、在树中删除一个项、在树中查找一个项、在树中访问一个项、清空树
>
>  
>
> 2.接口
>
>  [my_tree.h](include\my_tree.h) 
>
>  
>
> 3.实现
